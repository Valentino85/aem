...
_global_clientlib = renderContext.call("use", "/libs/granite/sightly/templates/clientlib.html", obj());
{
    ...
    {
        String var_templateoptions1_field$_categories = "sisal.base";
        {
...
out.write("\n");
{
    Object var_testvariable2 = renderContext.getObjectModel().resolveProperty(_dynamic_wcmmode, "edit");
    if (renderContext.getObjectModel().toBoolean(var_testvariable2)) {
        {
            ...
            {
                String var_templateoptions4_field$_categories = "sisal.author-mode";
                {
...
out.write("\n\n");
{
    ...
    {
        String var_templateoptions6_field$_categories = "granite.utils";
        {
