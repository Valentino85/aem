                            ...
                            for (Object child : var_collectionvar0_list_coerced$) {
                                {
                                    ...
                                    if (var_traversal9) {
                                        {
                                            Object var_resourcecontent10 = renderContext.call("includeResource", renderContext.getObjectModel().resolveProperty(child, "path"), obj().with("resourceType", renderContext.getObjectModel().resolveProperty(child, "resourceType")));
